...
public class LocalDynamoDbProvider {
    ...
    private static CreateTableRequest getCreateTableRequest(String tableName, String idFieldName) {
        final List<AttributeDefinition> definitions = Collections.singletonList(new AttributeDefinition()
    ...
    static LocalDynamoDbProvider create(final String tableName, final String idFieldName, final List<Item> items) {
